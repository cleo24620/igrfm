...
lat_start = 50; % Geodetic latitude in degrees.
lon_start = 0; % Geodetic longitude in degrees.
...
% lat = lat(alt >= 30); lon = lon(alt >= 30); alt = alt(alt >= 30);
% lat = lat(alt < 2000); lon = lon(alt < 2000); alt = alt(alt < 2000);
